...
export const devCmd = new Command("dev")
  .description("Run development server for Workers projects, etc. Use --runx-help to see all options.")
  .argument("[args...]", "Arguments to pass to the dev script. May need to use -- to pass options to the dev script.")
  .allowUnknownOption()
